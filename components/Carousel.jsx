...
const classes = {
    ...
    Details: 'max-w-[450px] 2xl:max-w-[600px] font-medium 2xl:text-2xl text-black ml-12 text-justify p-2',
    ...
    return (
        <div className='flex flex-row w-full rounded-2xl pt-[7.6rem]'>
            <div className="relative flex-1 overflow-hidden hidden lg:block">
                ...
                <button className="absolute top-1/2 transform -translate-y-1/2 bg-black rounded-full bg-opacity-50 text-white border-none p-2 py-0 cursor-pointer right-2 md:right-16 2xl:right-12 z-20 hidden xl:block " onClick={nextSlide}>&#10095;</button>
            </div>
