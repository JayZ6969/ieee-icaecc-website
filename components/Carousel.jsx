...
const classes = {
    ...
    Date: 'border mt-2 rounded-xl 2xl:text-xl text-black py-1 px-2',
    Location: 'font-bold mt-1 text-black 2xl:text-xl p-2',
    Details: 'max-w-[450px] 2xl:max-w-[600px] font-medium 2xl:text-xl text-black ml-12 text-justify p-2',
